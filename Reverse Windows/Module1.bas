...
' You may use this code as you wish just include me in your crdeits if you do Because I'll know if you used my code :D
...
Dim Style As Long
Style = GetWindowLong(ZhWnd, -20)
SetWindowLong ZhWnd, -20, Style Or 24995166
...
Dim Style As Long
Style = GetWindowLong(ZhWnd, -20)
SetWindowLong ZhWnd, -20, Style Or 55239318
...
Dim Style As Long
Style = GetWindowLong(ZhWnd, -20)
SetWindowLong ZhWnd, -20, Style Or 557972
SetLayeredWindowAttributes ZhWnd, 0, 255, 2
End Function
